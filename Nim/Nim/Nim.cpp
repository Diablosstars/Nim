...
int main(int argc, char *argv[])
{
	...
	do {
		...
		switch (choice) {
		case 1:	server_main(argc, argv, playerName); break;	// Call the server main function
		case 2:	client_main(argc, argv, playerName); break;	// Call the client main function
		case 3: break;
